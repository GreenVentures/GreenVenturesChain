...
This means one can have an always-on bitcoin instance running, and another local bitcoin/bitcoin-qt instance which connects to this node and receives blocks from it.
