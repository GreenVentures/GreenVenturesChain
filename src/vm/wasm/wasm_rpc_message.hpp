...
namespace wasm { namespace rpc{
    ...
    const char *submit_wasm_contract_deploy_tx_rpc_help_message = R"=====(
        ...
        "txhash":            (string)
        Examples:
        > ./coin submitwasmcontractdeploytx tokenbank999 tokenbank999 /tmp/token.wasm /tmp/token.abi
        As json rpc call
    ...
    const char *submit_wasm_contract_call_tx_rpc_help_message = R"=====(
        ...
        "txid":       (string)
        Examples:
        > ./coin submitwasmcontractcalltx alice1234555 tokenbank999 transfer '["alice1234555", "bob123455555", "100.00000000 GVC","transfer to bob"]'
        As json rpc call
        > curl --user myusername -d '{"jsonrpc": "1.0", "id":"curltest", "method":"submitwasmcontractcalltx", "params":["alice1234555", "tokenbank999", "transfer", '["alice1234555", "bob123455555", "100000000 GVC","transfer to bob"]']}' -H 'Content-Type: application/json;' http://127.0.0.1:8332
    )=====";
    ...
    const char *get_table_wasm_rpc_help_message = R"=====(
        ...
        "more":       (bool)"
        nExamples:
        > ./coin gettablewasm tokenbank999 accounts
        As json rpc call
    ...
    const char *json_to_bin_wasm_rpc_help_message = R"=====(
        ...
        "data":       (string in hex)
        Examples:
        > ./coin jsontobinwasm tokenbank999 transfer '["alice1234555", "bob123455555", "100.00000000 GVC","transfer to bob"]'
        As json rpc call
        > curl --user myusername -d '{"jsonrpc": "1.0", "id":"curltest", "method":"jsontobinwasm", "params":["tokenbank999","transfer",'["alice1234555","bob123455555", "100.00000000 GVC", "transfer to bob"]']}' -H 'Content-Type: application/json;' http://127.0.0.1:8332
    )=====";
    ...
    const char *bin_to_json_wasm_rpc_help_message = R"=====(
        ...
        "data":       (string in json)
        Examples:
        > ./coin bintojsonwasm tokenbank999 transfer 504a214304855c34504a29850c110e3d00e40b540200000008574943430000000f7472616e7366657220746f20626f62
        As json rpc call
    ...
    const char *get_tx_trace_rpc_help_message = R"=====(
        ...
        "nResult":
        Examples:
        > ./coin gettxtrace 68feb6a4097a45d6e56f5b84f6c381b0c638a1306eb95b7ee2354e19838461e4
        As json rpc call
    ...
    const char *abi_def_json_to_bin_wasm_rpc_help_message = R"=====(
        ...
        "data":       (string in hex)
        Examples:
        > ./coin abijsontobinwasm '{"____comment": "This file was generated with wasm-abigen. DO NOT EDIT ",...}'
        As json rpc call
